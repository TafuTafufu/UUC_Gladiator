...
function log(args) {
    ...
    if (role === 'core') {
        return [
            ...
            '',
            '<span style="color:#f5f2df"><b>387 日</b></span>',
            '<span style="color:#ccc">我们到达了"碎片"，迫切的想要进行任务的第二部分。明天我们的队伍将登陆。</span>',
            '',
            '<span style="color:#f5f2df"><b>388 日</b></span>',
            '<span style="color:#ccc">小队乘坐着空飞机降落。已经设置好营地和勘测设备。</span>',
            '',
            '<span style="color:#f5f2df"><b>389 日</b></span>',
            '<span style="color:#ccc">登陆的小队已经开始向神圣的中心挖掘出发，真希望我能和他们一道。继续监督他们的进度。</span>',
            '',
            '<span style="color:#f5f2df"><b>403 日</b></span>',
            '<span style="color:#ccc">小队已经进入碎片的核心中心，他们传回了一张图片，里面有一个似乎是金字塔的建筑。完全不符合物理学定律。小行星的内部尺寸比它可能的最大的尺寸还要打，拥有中立和大气。向不可名状者献上崇高的敬意，祝福他们混沌的神迹！我们发现了，真正的死去的卡尔克萨碎片，一个圣地！</span>',
            '',
            '<span style="color:#f5f2df"><b>405 日</b></span>',
            '<span style="color:#ccc">小队发现了一个巨大的中央腔，他们传回了详细的象形文字墙的扫描图。我们用 K2-PS187 翻译这些象形文字。小队发现了一个"坟墓"，上有如尼文的封印。</span>',
            '',
            '<span style="color:#f5f2df"><b>406 日</b></span>',
            '<span style="color:#ccc">K2-PS187 告诉我，象形文字描述了伊提被祝福之地卡尔克萨吸收之后的历史。</span>',
            '<span style="color:#ccc">它是用歌剧的形式表达的。我们发现了《黄色之王》的续集，这个故事多么辉煌！我已经命令电脑翻译，将这个故事合成为歌剧。小队摧毁了如尼文的封印，片刻后他们就失联了。</span>',
            '',
            '<span style="color:#f5f2df"><b>407 日</b></span>',
            '<span style="color:#ccc">"碎片"上登陆的航天飞机爆炸了。小队失联已达 20 小时。扫描器显示有一个人在航天飞机爆炸附近移动，它不是小队中的任何一个人。她自由了！我们的任务已经完成。我们没有能力再派一队人登录，而且所有的交流尝试都失败了。我们返回地球。我们已经竭尽全力了。</span>',
            '',
            '',
            '<span style="color:#f5f2df"><b>412 日</b></span>',
            '<span style="color:#ccc">K2-PS187 完成了翻译和制作歌剧的工作，船员们聚集在一起观看，但是主机的一些地方发生了故障。我们决定将观看推迟到技术问题得到解决。</span>',
            '',
            '<span style="color:#f5f2df"><b>414 日</b></span>',
            '<span style="color:#ccc">K2-PS187 系统发生故障。我们没办法重新控制它。自动门杀死了克雷文·约翰逊。我们打开了系统的安全/惩罚程序，但是系统仍然拒绝服从命令。</span>',
            '',
            '<span style="color:#f5f2df"><b>415 日</b></span>',
            '<span style="color:#ccc">K2-PS187 试图引爆主引力爆装置，让主引擎过载。我们已经关闭了计算机并试图用我们的个人终端操纵这艘船。</span>',
            '',
            '<span style="color:#f5f2df"><b>417 日</b></span>',
            '<span style="color:#ccc">截获了加密的无线电讯息，我们不能在没有主机的情况下确定来源或者解得信息。有一个文明生活在这里吗？一旦与地球重新建立起通讯，我们必须马上汇报这一情况。</span>',
            '',
            '<span style="color:#f5f2df"><b>418 日</b></span>',
            '<span style="color:#ccc">粒子风暴。导航系统失线，直到通过这一区域。</span>',
            '',
